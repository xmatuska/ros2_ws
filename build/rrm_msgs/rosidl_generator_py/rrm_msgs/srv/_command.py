...
class Metaclass_Command_Event(type):
    """Metaclass of message 'Command_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__command__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__command__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__command__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__command__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__command__event
...
class Command_Event(metaclass=Metaclass_Command_Event):
    """Message class 'Command_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rrm_msgs/Command_Request, 1>',
        'response': 'sequence<rrm_msgs/Command_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rrm_msgs', 'srv'], 'Command_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rrm_msgs', 'srv'], 'Command_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rrm_msgs.srv import Command_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Command_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Command_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from rrm_msgs.srv import Command_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Command_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Command_Response'"
...
class Metaclass_Command(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _command.Metaclass_Command_Event._TYPE_SUPPORT is None:
                _command.Metaclass_Command_Event.__import_type_support__()
...
class Command(metaclass=Metaclass_Command):
    ...
    from rrm_msgs.srv._command import Command_Event as Event
